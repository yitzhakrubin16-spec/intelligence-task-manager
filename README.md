...
מערכת לניהול סוכנים ומשימות עבור יחדית מודיעין ShadowNet.
...
|----|-------|-------------|----------|------------|------------|--------|------------|-------------------|
|מזהה ייחודי לכל משימה|כותרת המשימה|תיאור מפורט של המשימה|מיקום|רמת הקושי של המשימה|רמת החשיבות של המשימה|סטטוס המשימה|רמת הסיכון - מחושב לפי נוסחא לפי רמות הקושי והחשיבות|מספר מזהה של הסוכן ששוין למשימה|
